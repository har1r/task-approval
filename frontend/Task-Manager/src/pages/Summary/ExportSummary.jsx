                  ...
                  <table className="min-w-full text-sm table-fixed">
                    <thead className="sticky top-0 bg-slate-100/80 backdrop-blur text-slate-800">
                      <tr>
                        ...
                        {/* Nama pemohon fleksibel */}
                        <th className="border-b px-3 py-2 text-left font-semibold">
                          Nama Pemohon
                        </th>

                        {/* Kunci: beri min-width agar tidak menyusut, lalu nowrap */}
                        <th className="border-b px-3 py-2 text-left font-semibold min-w-[160px] md:min-w-[200px] whitespace-nowrap">
                          Jenis
                        </th>
                        <th className="border-b px-3 py-2 text-left font-semibold min-w-[240px] md:min-w-[300px] whitespace-nowrap">
                          No. Pengantar
                        </th>
                      </tr>
                    </thead>
                      ...
                      {tasks.map((t, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Ellipsis stabil: td max-w-0 + nowrap + span truncate */}
                            ...
                            <td className="border-b px-3 py-2 font-medium max-w-0 whitespace-nowrap">
                              <span className="block truncate" title={noPengantar}>
                                {noPengantar}
                              </span>
                            </td>
                          </tr>
...
//     <thead className="sticky top-0 bg-slate-100/80 backdrop-blur text-slate-800">
//       <tr>
//         <th className="border-b px-3 py-2 text-left font-semibold w-[56px]">No</th>
//         <th className="border-b px-3 py-2 text-left font-semibold w-[140px]">NOPEL</th>
//         <th className="border-b px-3 py-2 text-left font-semibold w-[160px]">NOP</th>

//         {/* Nama pemohon boleh fleksibel */}
//         <th className="border-b px-3 py-2 text-left font-semibold">Nama Pemohon</th>

//         {/* KUNCI: set width + nowrap */}
//         <th className="border-b px-3 py-2 text-left font-semibold w-[140px] whitespace-nowrap">
//           Jenis
//         </th>
//         <th className="border-b px-3 py-2 text-left font-semibold w-[220px] whitespace-nowrap">
//           No. Pengantar
//         </th>
//       </tr>
//     </thead>
...
//         const name = t?.additionalData?.[0]?.newName || "-";
//         const jenis = titleCase(t?.title || "");
//         const noPengantar = buildExportNumber(t?.exportNumber, t?.exportYear);
...
//             {/* ELLIPSIS: max-w-0 di TD + truncate di span */}
//             <td className="border-b px-3 py-2 capitalize max-w-0 whitespace-nowrap">
//               <span className="block truncate" title={jenis}>{jenis}</span>
//             </td>
//             <td className="border-b px-3 py-2 font-medium max-w-0 whitespace-nowrap">
//               <span className="block truncate" title={noPengantar}>{noPengantar}</span>
//             </td>
//           </tr>
//         );
//       })}
